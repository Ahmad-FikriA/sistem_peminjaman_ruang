<div class="flex min-h-screen flex-col gap-6 bg-gray-900 p-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-400">Update user information and role</p>
        </div>
    ...
    <div class="mx-auto w-full max-w-2xl">
        <form wire:submit.prevent="update" class="space-y-6 rounded-xl bg-gray-800 p-6 shadow-lg">
            <!-- Name Field -->
            <div>
            ...
            <!-- Password Field -->
            <div>
                <label for="password" class="block text-sm font-medium text-gray-200">New Password (leave blank to keep current)</label>
                <div class="mt-1">
