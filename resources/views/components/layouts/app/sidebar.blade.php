...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route(auth()->user()->role == 'user' ? 'dashboard' : 'admin.dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate>
                <x-app-logo />
            </a>
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Data Admin')" class="grid">
                    ...
                    <flux:navlist.item icon="inbox" :href="route( auth()->user()->role == 'user' ? 'dashboard' : 'admin.dashboard')" :current="request()->routeIs(auth()->user()->role == 'user' ? 'dashboard' : 'admin.dashboard' )" wire:navigate>{{ __('Pengelolaan User') }}</flux:navlist.item>
                    <flux:navlist.item icon="inbox" :href="route( auth()->user()->role == 'user' ? 'dashboard' : 'admin.dashboard')" :current="request()->routeIs(auth()->user()->role == 'user' ? 'dashboard' : 'admin.dashboard' )" wire:navigate>{{ __('Pengelolaan Booking') }}</flux:navlist.item>
